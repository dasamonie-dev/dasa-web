    ...
    <section className='relative bg-[radial-gradient(circle_at_top,#4b6b52,#031E3C)] flex items-center justify-center text-base'>
      <div className='mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 py-16 lg:py-24'>
        <div className='max-w-4xl mx-auto'>
          ...
          {/* Circular logo badge */}
          <div
            className='w-28 h-28 rounded-full bg-[#A1CF70] flex items-center justify-center shadow-md'
            data-aos='zoom-in'
            data-aos-delay={100}
          >
          ...
          {/* Heading */}
          <h2
            className='mt-10 text-base font-extrabold leading-tight text-3xl sm:text-4xl lg:text-5xl'
            data-aos='fade-up'
            data-aos-delay={300}
          >
