        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 mb-12 ">
          <div className="flex-1 max-w-xl ">
            ...
            <p className="mt-4 text-white/70 lg:text-2xl leading-relaxed max-w-sm">
              With Dasamonie Digital Service LTD, the speed, security, and
              simplicity you've been waiting for is already here. Take the first
              step now, your money will thank you.
            </p>
            ...
            <div className="mt-8">
              <p className="text-white text-sm mb-3">
                Stay updated with Dasamonie Digital Service LTD fintech
                insights.
              </p>
        ...
        <div className="flex flex-col gap-4 w-full">
          <div className="border-b border-white/10 pb-8 mt-4 flex flex-col sm:flex-row justify-between items-center gap-6">
            <p className="text-white/70 text-sm">
              © {currentYear} Dasamonie Digital Service LTD. All rights
              reserved.
            </p>
            <a
          ...
          <p className="self-center text-white/70 text-sm">
            Dasamonie Digital Service Ltd is a financial technology company, not
            a bank. Banking services and card issuance are provided by our
